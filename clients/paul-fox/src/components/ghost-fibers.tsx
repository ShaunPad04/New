...
/**
 * Ghost Fibers — a WebGL2 fibre-field background, ported from react-bits
 * (https://reactbits.dev, MIT). Renders into a full-size canvas inside the
 * wrapping div; pauses off-screen, when the tab is hidden and under
